window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const DICT_ZH = {
			...
			"stats.images": "图片",
			"stats.cost": "预估费用",
			"stats.costTip": "按 DeepSeek 官方刊例价估算整个会话的累计费用：输入区分缓存命中/未命中，输出含思考；按请求时间区分高峰（北京时间工作日 9:00–12:00、14:00–18:00）与空闲时段（半价，周末全天均为空闲时段）。适用于 deepseek-flash / deepseek-v4.1-flash / deepseek-v4-pro（不限 provider），价格写死在代码中，仅供参考。",
				...
				const catBody = (c) => {
					...
					if (c === "tools") {
						...
						const toolctl = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RowToolbar, {
							...
							children: ["size", "name"].map((k) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [toolctl, shown.map((tool) => {
							const trailing = tool.plugin !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		...
		const PLUGIN_REPO = "https://github.com/LunFengChen/dsh-context";
		...
		*/
		function makePluginInfo(kit) {
			...
			return function PluginInfo() {
				...
				const update = latest !== null && isNewerVersion(latest, "0.49.7") ? latest : null;
				const nameText = "dsh-context (v0.49.7)";
		...
		*/
		...
		function makeStatsContext(kit) {
			...
			return function StatsContext(props) {
				...
				const costTip = [t("stats.costTip"), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "lc-stat-tip-prices",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "lc-stat-tip-head",
						children: t("stats.costPriceHead")
					}), sessionPrices(currency).map((r) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "lc-card lc-col-stats",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "lc-card-title",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "lc-card-title-text",
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										className: "lc-kinds",
										children: EVENT_KINDS.map((k) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		*/
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/base.css.mjs
		...
		const tagId$13 = "@x1a0f3n9/dsh-context/base.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$13) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@x1a0f3n9/dsh-context";
			tag.dataset.pluginCss = tagId$13;
			tag.textContent = css$13;
			document.head.appendChild(tag);
		}
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/stats.css.mjs
		...
		const tagId$12 = "@x1a0f3n9/dsh-context/stats.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/jump.css.mjs
		...
		const tagId$11 = "@x1a0f3n9/dsh-context/jump.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/settings.css.mjs
		...
		const tagId$10 = "@x1a0f3n9/dsh-context/settings.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/stackedBar.css.mjs
		...
		const tagId$9 = "@x1a0f3n9/dsh-context/stackedBar.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/trendChart.css.mjs
		...
		const tagId$8 = "@x1a0f3n9/dsh-context/trendChart.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/requestDetail.css.mjs
		...
		const tagId$7 = "@x1a0f3n9/dsh-context/requestDetail.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/events.css.mjs
		...
		const tagId$6 = "@x1a0f3n9/dsh-context/events.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/fileCard.css.mjs
		...
		const tagId$5 = "@x1a0f3n9/dsh-context/fileCard.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/modal.css.mjs
		...
		const tagId$4 = "@x1a0f3n9/dsh-context/modal.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/browser.css.mjs
		...
		const tagId$3 = "@x1a0f3n9/dsh-context/browser.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/detailSections.css.mjs
		...
		const tagId$2 = "@x1a0f3n9/dsh-context/detailSections.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/attachments.css.mjs
		...
		const tagId$1 = "@x1a0f3n9/dsh-context/attachments.css";
		...
		//#endregion
		//#region \0dsh-global-css:/home/xiaofeng/Desktop/projects/dsh-context/src/client/styles/agentGraph.css.mjs
		...
		const tagId = "@x1a0f3n9/dsh-context/agentGraph.css";
